...
//
// Solidity: function initialize(address _wFIL, address _resolver, uint256 _initialDeposit) returns()
func (_LiquidStaking *LiquidStakingTransactor) Initialize(opts *bind.TransactOpts, _wFIL common.Address, _resolver common.Address, _initialDeposit *big.Int) (*types.Transaction, error) {
	return _LiquidStaking.contract.Transact(opts, "initialize", _wFIL, _resolver, _initialDeposit)
}

// Initialize is a paid mutator transaction binding the contract method 0x1794bb3c.
//
// Solidity: function initialize(address _wFIL, address _resolver, uint256 _initialDeposit) returns()
func (_LiquidStaking *LiquidStakingSession) Initialize(_wFIL common.Address, _resolver common.Address, _initialDeposit *big.Int) (*types.Transaction, error) {
	return _LiquidStaking.Contract.Initialize(&_LiquidStaking.TransactOpts, _wFIL, _resolver, _initialDeposit)
}

// Initialize is a paid mutator transaction binding the contract method 0x1794bb3c.
//
// Solidity: function initialize(address _wFIL, address _resolver, uint256 _initialDeposit) returns()
func (_LiquidStaking *LiquidStakingTransactorSession) Initialize(_wFIL common.Address, _resolver common.Address, _initialDeposit *big.Int) (*types.Transaction, error) {
	return _LiquidStaking.Contract.Initialize(&_LiquidStaking.TransactOpts, _wFIL, _resolver, _initialDeposit)
}
...
// Pledge is a paid mutator transaction binding the contract method 0x11a475a1.
//
// Solidity: function pledge(uint256 amount, uint64 _minerId) returns()
func (_LiquidStaking *LiquidStakingTransactor) Pledge(opts *bind.TransactOpts, amount *big.Int, _minerId uint64) (*types.Transaction, error) {
	return _LiquidStaking.contract.Transact(opts, "pledge", amount, _minerId)
}

// Pledge is a paid mutator transaction binding the contract method 0x11a475a1.
//
// Solidity: function pledge(uint256 amount, uint64 _minerId) returns()
func (_LiquidStaking *LiquidStakingSession) Pledge(amount *big.Int, _minerId uint64) (*types.Transaction, error) {
	return _LiquidStaking.Contract.Pledge(&_LiquidStaking.TransactOpts, amount, _minerId)
}

// Pledge is a paid mutator transaction binding the contract method 0x11a475a1.
//
// Solidity: function pledge(uint256 amount, uint64 _minerId) returns()
func (_LiquidStaking *LiquidStakingTransactorSession) Pledge(amount *big.Int, _minerId uint64) (*types.Transaction, error) {
	return _LiquidStaking.Contract.Pledge(&_LiquidStaking.TransactOpts, amount, _minerId)
}
