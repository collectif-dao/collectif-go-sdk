...
func (c *LotusClient) Deposit(ctx context.Context, amount *big.Int, send bool) (*MessageResponse, error) {
	log.Info("Depositing collateral for ", AttoFIL2FIL_str(amount), " FIL")
	...
	log.Info("Succesfully deposited collateral for ", AttoFIL2FIL_str(amount), " FIL")
	return res, nil
}

func (c *LotusClient) Withdraw(ctx context.Context, amount *big.Int, send bool) (*MessageResponse, error) {
	log.Info("Withdrawing collateral for ", AttoFIL2FIL_str(amount), " FIL")
	method := "withdraw"
	...
	log.Info("Succesfully withdrawn collateral for ", AttoFIL2FIL_str(amount), " FIL")
	return res, nil
}
